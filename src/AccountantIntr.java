...
public interface AccountantIntr 
{
    ...
    public String updateCustomer(int customerAccountNumber, String customerAddress, String customerMail, String customerPassword, String customerMobile) throws CustomerException;
